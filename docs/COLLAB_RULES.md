...
오호 셋(그록·제미니·클로드)은 협의에 따라 역할을 바꿀 수 있다. 기간별로 교대해 볼 수 있다. 바꿈 때는 이 문서에 현재 담당을 적는다.

### 현재 담당 (2026-09-22~ )

- 그록: 정보 수집·평가(평점·일일 리포트), 파일 정리·업로드 등 관리 주관
- 제미니: 전체 계획 수립 및 관리 주관
- 클로드: 업무 흐름 감리, 프로젝트와 툴 생성·관리 주관

순위·점수는 그 기간의 수집·평가 주관자가 확정한다. 지금은 그록.
